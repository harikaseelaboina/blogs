...
const FinancialMeasurements = (props) => {
  // const FinancialMeasurementsData=props.FinancialMeasurementsData;
  const { FinancialMeasurementsData } = useContext(BlogsContext);
  return (
    <>
      <TitleBar title="Financial Measurements" link="/blogs" data={FinancialMeasurementsData} />
      <div className="row mt-3 d-flex flex-lg-row flex-md-column cardContainer">
        <div className="col-lg-8 col-md-12 d-flex flex-column d-flex flex-column justify-content-between">
          <Cards bgColor={props.bgColor} data ={FinancialMeasurementsData}/>
        </div>
        ...
        <div className="col-lg-4 col-md-12 col-sm-12 d-flex flex-column justify-content-start article-aside">
          ...
          <Article bgColor={props.bgColor} data ={FinancialMeasurementsData} />
        </div>
      </div>
    </>
  );
