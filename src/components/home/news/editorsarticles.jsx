      ...
      <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div className="col-12 d-flex m-auto" >
          ...
          <div className="col-12" style={{paddingLeft:"1rem",paddingRight:"1rem",}}>
            <button  onClick={handleNavigate} style={{width:"100%",textAlign:"center",marginTop:"0.5rem",borderRadius:"10px",fontSize:"22px",backgroundColor:"black",color:"white"}}>View all</button>
          </div>
          </div>
        </div>
