...
const Luxurycarousel = (props) => {
  ...
  return (
   ...
   backgroundColor:" #BBA592",padding:"0.5rem",width:"80%",marginLeft:"auto",marginRight:"auto"}}>
    <div
      className="luxcar"
      style={{
        width: "90%",
        ...
        >
               ...
               <div style={{height:"luxcar",display:"flex",flexDirection:"column",justifyContent:"center",}} >
                ...
                <div style={{ position:"relative",backgroundImage: `url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTxsiHSwtRWQGR2uzbr568fB2b-bIO0u_X_BdHyPlr6jeCDvGdebfZYm3-Uo-7q34zPcGQ&usqp=CAU)`,height:"15rem",backgroundPosition:"center",backgroundSize:"cover",borderTopLeftRadius:"10px",borderTopRightRadius:"10px"}}>
                 ...
                 <div style={{position:"absolute",top:"5%",padding:"0.2rem",display:"flex",flexDirection:"column",justifyContent:"flex-start",alignItems:"start",}}>
                    <button style={{backgroundColor:"transparent",border:"2px black solid",borderRadius:"20px",paddingLeft:"0.5rem",fontSize:"12px",paddingRight:"0.5rem"}}>Luxury Projects</button>
                 </div>
                </div>
               
               
               <div style={{display:"flex",color:"white",flexDirection:"column",backgroundColor:"black",borderBottomLeftRadius:"10px",borderBottomRightRadius:"10px",padding:"0.5rem"}}>
             ...
             <span style={{display:"flex",justifyContent:"center"}}>
                <button   onClick={handleShowModal} style={{backgroundColor:"black",color:"white",borderRadius:"30px",border:"2px solid green",width:"60%"}}>Request Call Back</button>
